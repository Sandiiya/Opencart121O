...
//			}
			...
			//driver=new RemoteWebDriver(new URL("http://http://localhost:4444/wd/hub"),capabilities);
	...
	//	private org.apache.logging.log4j.core.Logger LogManager(Class<? extends BaseClass> class1) {
